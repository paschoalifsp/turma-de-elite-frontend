...
export class AchievementFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.route.params.subscribe(value => {
      if(value['id']){
        ...
        this.achievementService.getAchievementById(this.achievementId as number).subscribe(({email,name,isActive,school})=>{
          this.achievementForm.setValue({email,name,isActive,school});
        });
      }
    })
  }
  ...
  ngOnChanges(changes: SimpleChanges){
    ...
    if(this.createMode){
      ...
      this.achievementService.getAchievementById(this.achievementId as number).subscribe( ({name,email,isActive,school}) => {
        this.achievementForm.setValue({name,email,isActive,school})
      })
    }
  }
  ...
  updateAchievement(){
    this.isLoading = true;
    this.achievementService.updateAchievement(this.achievementId,this.achievementForm.value).subscribe(success => {
  ...
  registerAchievement(){
    this.isLoading = true;
    this.achievementService.createAchievement(this.achievementForm.value).subscribe(success => {
  ...
  selectIcon(icon: string) {
    console.log(icon);
    this.achievementForm.get('iconName')?.setValue(icon);
  }
}
